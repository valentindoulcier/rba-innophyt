				...
				$.ajax({
					...
					success : function(msg) {
						if (msg == authInfo.idKeyMd5) {
							...
							$('#footer p.right').html('Vous êtes connecté en tant que ' + authInfo.loginEmail + '<i class="icon-ok-sign"></i> - <a href="<?php echo $MENU_URL ?>" alt="Menu">Menu</a> <i class="icon-th"></i> - <a href="#" title="Déconnexion" onClick="logout();">Déconnexion</a>');
